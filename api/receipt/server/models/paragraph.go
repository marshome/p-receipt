...
// Validate validates this paragraph
func (m *Paragraph) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Paragraph) validateBoundingBox(formats strfmt.Registry) error {
...
func (m *Paragraph) validateProperty(formats strfmt.Registry) error {
...
func (m *Paragraph) validateWords(formats strfmt.Registry) error {
...
func (m *Paragraph) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Paragraph) UnmarshalBinary(b []byte) error {
	var res Paragraph
